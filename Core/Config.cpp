...
static ConfigSetting graphicsSettings[] = {
	...
	ReportedConfigSetting("NNEDI3NeuronsY", &g_Config.iNNEDI3NeuronsY, 0, true, true),
	ReportedConfigSetting("NNEDI3NeuronsUV", &g_Config.iNNEDI3NeuronsUV, 5, true, true),
	ReportedConfigSetting("NNEDI3NeuronsA", &g_Config.iNNEDI3NeuronsA, 0, true, true),
